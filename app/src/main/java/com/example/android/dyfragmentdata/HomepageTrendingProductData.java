...
public class HomepageTrendingProductData {
    ...
    public HomepageTrendingProductData(String productId, String templeName, String templeLocation, String mImageUrl, String rating, String wishlist) {
